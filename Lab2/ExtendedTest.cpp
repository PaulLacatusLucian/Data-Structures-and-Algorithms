...
void testDeleteIterator() {
    cout << "Test delete iterator" << endl;
    MultiMap m;
    m.add(33, 33);
    m.add(44,44);
    MultiMapIterator it = m.iterator();
    ...
    assert(elem.first == 44);
    assert(elem.second == 44);
    it.first();
    elem = it.getCurrent();
    assert (elem.first == 44);
    ...
    m1.add(44,44);
    m1.add(55,55);
    MultiMapIterator it2 = m1.iterator();
    it2.next();
    elem = it2.getCurrent();
    assert (elem.first == 44);
    assert (elem.second == 44);
    it2.deleteCurrent();
    elem = it2.getCurrent();
    assert (elem.first == 55);
    assert (elem.second == 55);
    it2.next();
    ...
    m2.add(33, 33);
    m2.add(44,44);
    MultiMapIterator it3 = m2.iterator();
    it3.next();
    try {
        it.deleteCurrent();
    }
